import { Badge, Box, Button, Card, Container, Flex, Grid, Section } from '../../src';
  ...
  return (
    <Container as="main" className="site-page">
      <Section className="hero" py={0}>
        <Badge variant="soft" size="2" color="blue" className="hero-kicker-badge">base-ic</Badge>
        ...
        <Flex className="hero-actions" gap={2}>
          <Button variant="solid" size="3" onClick={() => goTo('docs')}>Read Docs</Button>
          <Button variant="surface" size="3" onClick={() => goTo('playground')}>Open Playground</Button>
        </Flex>
      </Section>
