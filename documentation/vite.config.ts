  ...
  build: {
    rollupOptions: {
      input: {
        ...
        docsCheckbox: resolve(__dirname, 'docs/checkbox/index.html'),
        docsSwitch: resolve(__dirname, 'docs/switch/index.html'),
        docsRadioGroup: resolve(__dirname, 'docs/radio-group/index.html'),
        docsInput: resolve(__dirname, 'docs/input/index.html'),
        docsSelect: resolve(__dirname, 'docs/select/index.html'),
        docsAutocomplete: resolve(__dirname, 'docs/autocomplete/index.html'),
        docsTextarea: resolve(__dirname, 'docs/textarea/index.html'),
        docsTabs: resolve(__dirname, 'docs/tabs/index.html'),
        docsNavigationMenu: resolve(__dirname, 'docs/navigation-menu/index.html'),
        docsDialog: resolve(__dirname, 'docs/dialog/index.html'),
        docsAlertDialog: resolve(__dirname, 'docs/alert-dialog/index.html'),
        docsDrawer: resolve(__dirname, 'docs/drawer/index.html'),
        docsToast: resolve(__dirname, 'docs/toast/index.html'),
        docsAccordion: resolve(__dirname, 'docs/accordion/index.html'),
        docsSlider: resolve(__dirname, 'docs/slider/index.html'),
        docsProgress: resolve(__dirname, 'docs/progress/index.html'),
        docsAvatar: resolve(__dirname, 'docs/avatar/index.html'),
        ...
        docsCollapsible: resolve(__dirname, 'docs/collapsible/index.html'),
        docsSkeleton: resolve(__dirname, 'docs/skeleton/index.html'),
